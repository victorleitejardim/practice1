...
Using the function to read, join and select only the Ursidae (we can select any species with parameter **fam**) species from the wildfinder database "read_wildfinder", let's load the full table
